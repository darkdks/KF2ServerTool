...
type
  ...
  var
  public
    property OnDownloadProgress: TRDMOnProgress read FTRDMOnProgress
      write FTRDMOnProgress;
    property OnDownloadStarted: TRDMOnStarted read FTRDMOnStarted
      write FTRDMOnStarted;
    property OnDownloadFinished: TRDMOnFinished read FTRDMOnFinished
      write FTRDMOnFinished;
